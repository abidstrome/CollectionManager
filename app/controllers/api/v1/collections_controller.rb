class Api::V1::CollectionsController < ApplicationController
    ...
    def index
      ...
      if user
        collections = user.collections.select(:id, :name, :description, :category_id, :user_id).as_json
        ccollections.each do |collection|
            collection['item_count'] = Collection.find(collection['id']).items.count
          end
